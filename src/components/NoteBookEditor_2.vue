    ...
    <div class="editor">
        ...
        <editor-menu-bar :editor="editor" v-slot="{ commands, isActive }" class="menu">
            <div>
                ...
                <el-button type="primary" size="small" :class="{ 'is-active': isActive.italic() }"
                           @click="commands.italic">
                    Italic
                </el-button>
                <el-button type="primary" size="small" :class="{ 'is-active': isActive.blockquote() }"
                ...
                <el-button type="warning" size="small" :class="{ 'is-active': isActive.link() }"
                           @click="setLinkUrl(commands.link, null)">
                    Link
                    <span>{{ isActive.link() ? 'Update Link' : 'Add Link'}}</span>
                </el-button>
                <el-button type="danger" size="small" :class="{ 'is-active': isActive.strike() }"
                           @click="commands.strike">
                    Strike
                </el-button>
                <el-button type="danger" size="small" :class="{ 'is-active': isActive.underline() }"
        ...
        <editor-content :editor="editor" class="editorContent"></editor-content>
    </div>
